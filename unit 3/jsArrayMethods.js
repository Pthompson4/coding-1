...
//push method () - pushing new data out into an array. push needs an argument to be passed out into the array
generalist.push('new data')
console.log(generalist)

// pop method() - this method removes a piece of data from a list it'll remove the last item in that list. pop does not need an arguement
// it'll always remove
generalist.pop()
console.log(generalist)
